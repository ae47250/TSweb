...
- Active PDF-ready records: 318
- Newly blocked under shadow enforcement: 183
- Potential regressions requiring held-out semantic review: 150

## Mutually Exclusive Categories

| Category | Count |
|---|---:|
| shadow_correction_available_no_block | 133 |
| potential_regression_dependent_addon_structure | 100 |
| unchanged_not_pdf_ready | 61 |
| potential_regression_other_structural | 50 |
