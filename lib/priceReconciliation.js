...
export function reconcileSidecarPrices(alphaJson = {}, optionPriceCandidateView = null) {
  ...
  const computedAddOnByTotalAmount = new Map(highConfidenceComputedAddOns
  ...
  const finalOptions = normalizeComputedAddOnOptionSequence(duplicatePriceCollapse.items, highConfidenceComputedAddOns);
