...
function combinedAddOnScope(interpretation) {
  const baseScope = conciseBaseScope(interpretation.base_description || "") || "base tree work";
  let addOnScope = (basicCustomerFacingScope(interpretation.add_on_description || "")
