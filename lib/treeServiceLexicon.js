...
export const TREE_SERVICE_LEXICON_VERSION = "0.1.0-repo";
...
const TREE_SERVICE_CONCEPTS = {
  ...
  "service.limb_removal": {
    ...
    aliases: {
      ...
      vernacular: ["get the limb down", "take down the branch", "cut up the limb"],
    },
  },
  "service.hanging_limb_removal": {
    ...
    aliases: {
      professional: ["widow-maker removal", "hanger removal", "hung limb removal"],
  ...
  "service.storm_cleanup": {
    ...
    aliases: {
      ...
      vernacular: ["clear storm damage", "clean up after storm", "cut up storm limbs"],
    },
  },
  ...
  "service.stump_grinding": {
    ...
    aliases: {
      professional: ["stump grinding", "root grinding", "stump grind", "grind stump", "grind the stump", "grind the roots", "root grind", "stump ground", "stumping"],
      vernacular: ["grind it out", "chew the stump", "stump grinder", "grind the roots"],
    },
  },
  ...
  "service.debris_removal": {
    ...
    aliases: {
      professional: ["haul away", "haul away debris", "debris haul", "haul debris", "haul off", "haul", "hauled", "hauling", "debris removal", "green waste removal", "wood removal", "log removal", "log hauling", "brush removal", "disposal", "dump fee", "dump fees", "tipping fee", "tipping fees"],
      vernacular: ["haul it away", "take the mess", "get rid of the brush", "clean everything up", "take the debris", "take the logs"],
    },
  },
  "service.chipping": {
    label: "Chipping",
    ...
    existing_service_kind: "brush_cleanup",
    aliases: {
      professional: ["chip", "chipping", "brush chipping", "chip brush", "mulch chip", "mulch chip and leave"],
      vernacular: ["run it through the chipper", "chip up the brush", "chip the brush"],
    },
  },
  "service.wood_bucking": {
    ...
    aliases: {
      ...
      vernacular: ["cut it into firewood", "cut firewood length"],
    },
  },
  ...
  "service.fine_cleanup": {
    ...
    existing_service_kind: "brush_cleanup",
    aliases: {
      professional: ["cleanup", "clean up", "clean area", "clean work area", "final cleanup", "site cleanup", "yard protection cleanup", "access cleanup", "rake-up", "rake", "blow", "restore work area"],
      vernacular: ["clean the yard", "clean driveway area", "clean porch area", "rake it out", "make it neat", "clean up the site"],
    },
  },
  ...
  "service.pruning": {
    ...
    existing_service_kind: "tree_trim",
    aliases: {
      professional: ["trim", "trimming", "tree trim", "tree trimming", "prune", "pruning", "deadwooding", "dead wooding"],
  ...
  "disposition.wood_left": {
    ...
    kind: "disposition",
    aliases: {
      professional: ["leave wood", "leave the wood", "leave wood on site", "wood left on site", "logs left on site", "leave logs", "leave the logs", "stack firewood", "stack wood"],
      vernacular: ["customer keeps wood", "wood can stay", "logs can stay", "stack the firewood"],
    },
  },
  ...
  "disposition.chips_left": {
    ...
    kind: "disposition",
    aliases: {
      professional: ["leave chips", "leave the chips", "chips left on site", "chip and leave", "mulch chip and leave"],
      vernacular: ["chips can stay", "pile the chips here", "leave the mulch chips"],
    },
  },
