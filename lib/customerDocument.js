...
export function renderCustomerDocument(alphaJson, { mobile = false, signature = "", selectedOption = "" } = {}) {
...
<body>
  <main class="page">
    ...
    <section>
      ...
      <div class="box">${esc(alphaJson.job?.description)}</div>
    </section>
    <section>
      <h2>Options</h2>
    ...
    <section>
      ...
      <div class="actions">
        <a class="secondary" href="mailto:${TREE_DUDE_EMAIL}?subject=Signed Estimate ${esc(alphaJson.document?.number)}">Email to Tree Dude</a>
