...
function factsWithFinalContext(finalFacts = {}, finalContextFacts = {}) {
  return {
    ...
    tree_quantity: finalFacts.tree_quantity || finalContextFacts.tree_quantity || null,
    target_qualifiers: unique([
    ...
    final_text: compact([finalFacts.final_text, finalContextFacts.final_text].filter(Boolean).join(" ")),
  };
}
