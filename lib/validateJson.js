...
function countTokenToNumber(value) {
  ...
  if (/^\d+$/.test(text)) {
    ...
    return numeric > 0 && numeric <= 20 ? numeric : null;
  }
...
export function validateAlphaJson(input) {
  ...
  } else if (!acceptedTreeCountOverride && !treeCount && !treeCountIsVague && !optionsHaveUnclearScope && !hasClearWorkScope(description, options)) {
