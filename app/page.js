  ...
  return (
    <main className={usesPurpleBackground ? "app-stage-purple" : ""}>
      <section className="banner">
        <h1>Alpha Tree</h1>
        <p><a className="banner-branch-url" href="https://tsweb-git-master-version100-ea47243.vercel.app">https://tsweb-git-master-version100-ea47243.vercel.app</a>: Production version with deployed + more parsers/normalizers</p>
      </section>
